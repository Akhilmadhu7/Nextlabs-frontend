import React, {useContext, useEffect, useSta, useState} from "react";
    ...
    <div>
      <div className="relative py-16 my-10 mr-4 bg-gradient-to-br from-sky-50 to-gray-200">
        <div className="relative container m-auto px-6 text-gray-500 md:px-12 xl:px-40">
          ...
          <div>
          <h2 className="text-indigo-700  text-center text-3xl font-semibold underline mb-4 uppercase decoration-wavy">
            Points
          </h2>
        </div>
